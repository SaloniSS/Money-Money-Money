    ...
    <div className="App">
      <header className="App-header">
        ...
        <p>
          ...
          the extension of the future, MoneyMoneyMoney! Must be funny, in a rich
          man's world... Since we all aren't rich how about you compare
          unnecessary purchases to things you really want?
        </p>
        ...
        <div className="button-area">
          <Button className="button" variant="contained">
            <a
              href="https://chrome.google.com/webstore/detail/money-money-money/ehdcenmhmjlkmlnmlglncndglmoglojd"
              target="_blank"
        ...
        <div className="button-area">
          <Button className="button" variant="contained">
            <a
              href="https://devpost.com/software/moneymoneymoney"
              target="_blank"
              rel="noopener noreferrer"
            >
              More Info
        ...
        <div className="button-area">
          <Button className="button" variant="contained">
            <a
              href="https://github.com/SaloniSS/Money-Money-Money"
              target="_blank"
              rel="noopener noreferrer"
            >
              Source Code
